                    ...
                    <form action="" class="mt-3">
                        ...
                        <div class="mb-2">
                            <div class="form-check mb-2">
                                ...
                                <label for="flexCheckChecked1" class="form-check-label">Desain & Kreatif</label>
                            </div>
                        </div>
                        <div class="mb-2">
                            <div class="form-check mb-2">
                                ...
                                <label for="flexCheckChecked2" class="form-check-label">Penjualan & Pemasaran</label>
                            </div>
                        </div>
                        <div class="mb-2">
                            <div class="form-check mb-2">
                                ...
                                <label for="flexCheckChecked3" class="form-check-label">Akuntansi</label>
                            </div>
                        </div>
                    </form>
                </div>
